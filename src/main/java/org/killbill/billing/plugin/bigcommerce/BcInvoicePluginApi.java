...
class BcInvoicePluginApi extends PluginInvoicePluginApi implements OSGIKillbillEventHandler {

    public BcInvoicePluginApi(final OSGIKillbillAPI killbillAPI, final OSGIConfigPropertiesService configProperties,
                                      final Clock clock) {
