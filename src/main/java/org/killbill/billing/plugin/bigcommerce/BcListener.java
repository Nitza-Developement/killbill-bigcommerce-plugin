...
public class BcListener implements OSGIKillbillEventDispatcher.OSGIKillbillEventHandler {
    ...
    public BcListener(final OSGIKillbillAPI killbillAPI, final ServiceTracker<InvoiceFormatterFactory, InvoiceFormatterFactory> invoiceFormatterTracker, Properties configProperties) {
    ...
    public void handleKillbillEvent(final ExtBusEvent killbillEvent) {
        ...
        switch (killbillEvent.getEventType()) {
            ...
            case INVOICE_CREATION:
                ...
                final List<Invoice> invoices = osgiKillbillAPI.getInvoiceUserApi().getInvoicesByAccount(
                ...
                logger.info("Invoices in bigcommerce-plugin {}: ",invoices.size());
                ...
                logger.info("bigcommerce-plugin got items:{}",items.size());
                ...
                for(InvoiceItem item:items) {
                    ...
                    logger.info("bigcommerce-plugin formattedEndDate:{}",formattedEndDate);
                }
            // Nothing
            default:
                break;
